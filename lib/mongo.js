...
var picSchema = mongoose.Schema({date: { type: Date, default: Date.now }, type: String });
...
var addPic = function(callback) {
	...
	var item = new picItem({type: 'none'});
...
var changePic = function(elementID, uploadName) {
	...
	// update db item
	picItem.update({ _id: elementID }, {$set: { type: 'upload' }}, function() {
